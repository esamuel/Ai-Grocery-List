...
var ApiVersion = "2025-09-30.clover";
...
var PaymentIntents = StripeResource.extend({
  create: stripeMethod103({ method: "POST", fullPath: "/v1/payment_intents" }),
  ...
  applyCustomerBalance: stripeMethod103({
    method: "POST",
  ...
  capture: stripeMethod103({
    method: "POST",
    fullPath: "/v1/payment_intents/{intent}/capture"
  }),
  confirm: stripeMethod103({
    method: "POST",
    fullPath: "/v1/payment_intents/{intent}/confirm"
  }),
  incrementAuthorization: stripeMethod103({
    method: "POST",
    fullPath: "/v1/payment_intents/{intent}/increment_authorization"
  }),
  search: stripeMethod103({
    method: "GET",
    fullPath: "/v1/payment_intents/search",
    methodType: "search"
  }),
  verifyMicrodeposits: stripeMethod103({
    method: "POST",
...
var PaymentLinks = StripeResource.extend({
  create: stripeMethod104({ method: "POST", fullPath: "/v1/payment_links" }),
...
var PaymentMethods = StripeResource.extend({
  create: stripeMethod107({ method: "POST", fullPath: "/v1/payment_methods" }),
  ...
  attach: stripeMethod107({
    method: "POST",
    fullPath: "/v1/payment_methods/{payment_method}/attach"
  }),
  detach: stripeMethod107({
    method: "POST",
...
var Payouts = StripeResource.extend({
  create: stripeMethod108({ method: "POST", fullPath: "/v1/payouts" }),
  retrieve: stripeMethod108({ method: "GET", fullPath: "/v1/payouts/{payout}" }),
  update: stripeMethod108({ method: "POST", fullPath: "/v1/payouts/{payout}" }),
...
var Plans = StripeResource.extend({
  create: stripeMethod109({ method: "POST", fullPath: "/v1/plans" }),
  retrieve: stripeMethod109({ method: "GET", fullPath: "/v1/plans/{plan}" }),
  update: stripeMethod109({ method: "POST", fullPath: "/v1/plans/{plan}" }),
  list: stripeMethod109({
    method: "GET",
    fullPath: "/v1/plans",
    methodType: "list"
  }),
  del: stripeMethod109({ method: "DELETE", fullPath: "/v1/plans/{plan}" })
});

// node_modules/stripe/esm/resources/Prices.js
var stripeMethod110 = StripeResource.method;
var Prices = StripeResource.extend({
  create: stripeMethod110({ method: "POST", fullPath: "/v1/prices" }),
  retrieve: stripeMethod110({ method: "GET", fullPath: "/v1/prices/{price}" }),
  update: stripeMethod110({ method: "POST", fullPath: "/v1/prices/{price}" }),
...
var Products2 = StripeResource.extend({
  create: stripeMethod111({ method: "POST", fullPath: "/v1/products" }),
  retrieve: stripeMethod111({ method: "GET", fullPath: "/v1/products/{id}" }),
  update: stripeMethod111({ method: "POST", fullPath: "/v1/products/{id}" }),
  list: stripeMethod111({
    method: "GET",
    fullPath: "/v1/products",
    methodType: "list"
  }),
  del: stripeMethod111({ method: "DELETE", fullPath: "/v1/products/{id}" }),
  createFeature: stripeMethod111({
    method: "POST",
    fullPath: "/v1/products/{product}/features"
  }),
  deleteFeature: stripeMethod111({
    method: "DELETE",
    fullPath: "/v1/products/{product}/features/{id}"
  }),
  listFeatures: stripeMethod111({
    method: "GET",
    fullPath: "/v1/products/{product}/features",
    methodType: "list"
  }),
  retrieveFeature: stripeMethod111({
    method: "GET",
    fullPath: "/v1/products/{product}/features/{id}"
  }),
...
var PromotionCodes = StripeResource.extend({
  create: stripeMethod112({ method: "POST", fullPath: "/v1/promotion_codes" }),
...
var Quotes = StripeResource.extend({
  create: stripeMethod113({ method: "POST", fullPath: "/v1/quotes" }),
  retrieve: stripeMethod113({ method: "GET", fullPath: "/v1/quotes/{quote}" }),
  update: stripeMethod113({ method: "POST", fullPath: "/v1/quotes/{quote}" }),
  list: stripeMethod113({
    method: "GET",
    fullPath: "/v1/quotes",
    methodType: "list"
  }),
  accept: stripeMethod113({ method: "POST", fullPath: "/v1/quotes/{quote}/accept" }),
  cancel: stripeMethod113({ method: "POST", fullPath: "/v1/quotes/{quote}/cancel" }),
  finalizeQuote: stripeMethod113({
    method: "POST",
    fullPath: "/v1/quotes/{quote}/finalize"
  }),
  listComputedUpfrontLineItems: stripeMethod113({
    method: "GET",
...
var Refunds2 = StripeResource.extend({
  create: stripeMethod114({ method: "POST", fullPath: "/v1/refunds" }),
  retrieve: stripeMethod114({ method: "GET", fullPath: "/v1/refunds/{refund}" }),
  update: stripeMethod114({ method: "POST", fullPath: "/v1/refunds/{refund}" }),
  list: stripeMethod114({
    method: "GET",
    fullPath: "/v1/refunds",
    methodType: "list"
  }),
  cancel: stripeMethod114({
    method: "POST",
...
var Reviews = StripeResource.extend({
  retrieve: stripeMethod115({ method: "GET", fullPath: "/v1/reviews/{review}" }),
  list: stripeMethod115({
    method: "GET",
    fullPath: "/v1/reviews",
    methodType: "list"
  }),
  approve: stripeMethod115({
    method: "POST",
...
var SetupIntents = StripeResource.extend({
  create: stripeMethod117({ method: "POST", fullPath: "/v1/setup_intents" }),
  ...
  confirm: stripeMethod117({
    method: "POST",
    fullPath: "/v1/setup_intents/{intent}/confirm"
  }),
  verifyMicrodeposits: stripeMethod117({
    method: "POST",
...
var ShippingRates = StripeResource.extend({
  create: stripeMethod118({ method: "POST", fullPath: "/v1/shipping_rates" }),
...
var Sources = StripeResource.extend({
  create: stripeMethod119({ method: "POST", fullPath: "/v1/sources" }),
  retrieve: stripeMethod119({ method: "GET", fullPath: "/v1/sources/{source}" }),
  update: stripeMethod119({ method: "POST", fullPath: "/v1/sources/{source}" }),
  listSourceTransactions: stripeMethod119({
    method: "GET",
    fullPath: "/v1/sources/{source}/source_transactions",
    methodType: "list"
  }),
  verify: stripeMethod119({
    method: "POST",
...
var SubscriptionItems = StripeResource.extend({
  create: stripeMethod120({ method: "POST", fullPath: "/v1/subscription_items" }),
...
var Subscriptions = StripeResource.extend({
  create: stripeMethod122({ method: "POST", fullPath: "/v1/subscriptions" }),
  ...
  cancel: stripeMethod122({
    method: "DELETE",
    fullPath: "/v1/subscriptions/{subscription_exposed_id}"
  }),
  deleteDiscount: stripeMethod122({
    method: "DELETE",
    fullPath: "/v1/subscriptions/{subscription_exposed_id}/discount"
  }),
  migrate: stripeMethod122({
    method: "POST",
    fullPath: "/v1/subscriptions/{subscription}/migrate"
  }),
  resume: stripeMethod122({
    method: "POST",
    fullPath: "/v1/subscriptions/{subscription}/resume"
  }),
  search: stripeMethod122({
    method: "GET",
...
var TaxCodes = StripeResource.extend({
  retrieve: stripeMethod123({ method: "GET", fullPath: "/v1/tax_codes/{id}" }),
...
var TaxIds = StripeResource.extend({
  create: stripeMethod124({ method: "POST", fullPath: "/v1/tax_ids" }),
  retrieve: stripeMethod124({ method: "GET", fullPath: "/v1/tax_ids/{id}" }),
  list: stripeMethod124({
    method: "GET",
    fullPath: "/v1/tax_ids",
    methodType: "list"
  }),
  del: stripeMethod124({ method: "DELETE", fullPath: "/v1/tax_ids/{id}" })
});

// node_modules/stripe/esm/resources/TaxRates.js
var stripeMethod125 = StripeResource.method;
var TaxRates = StripeResource.extend({
  create: stripeMethod125({ method: "POST", fullPath: "/v1/tax_rates" }),
  retrieve: stripeMethod125({ method: "GET", fullPath: "/v1/tax_rates/{tax_rate}" }),
  update: stripeMethod125({ method: "POST", fullPath: "/v1/tax_rates/{tax_rate}" }),
...
var Tokens2 = StripeResource.extend({
  create: stripeMethod126({ method: "POST", fullPath: "/v1/tokens" }),
  retrieve: stripeMethod126({ method: "GET", fullPath: "/v1/tokens/{token}" })
});

// node_modules/stripe/esm/resources/Topups.js
var stripeMethod127 = StripeResource.method;
var Topups = StripeResource.extend({
  create: stripeMethod127({ method: "POST", fullPath: "/v1/topups" }),
  retrieve: stripeMethod127({ method: "GET", fullPath: "/v1/topups/{topup}" }),
  update: stripeMethod127({ method: "POST", fullPath: "/v1/topups/{topup}" }),
  list: stripeMethod127({
    method: "GET",
    fullPath: "/v1/topups",
    methodType: "list"
  }),
  cancel: stripeMethod127({ method: "POST", fullPath: "/v1/topups/{topup}/cancel" })
});

// node_modules/stripe/esm/resources/Transfers.js
var stripeMethod128 = StripeResource.method;
var Transfers = StripeResource.extend({
  create: stripeMethod128({ method: "POST", fullPath: "/v1/transfers" }),
  retrieve: stripeMethod128({ method: "GET", fullPath: "/v1/transfers/{transfer}" }),
  update: stripeMethod128({ method: "POST", fullPath: "/v1/transfers/{transfer}" }),
  list: stripeMethod128({
    method: "GET",
    fullPath: "/v1/transfers",
    methodType: "list"
  }),
  createReversal: stripeMethod128({
    method: "POST",
    fullPath: "/v1/transfers/{id}/reversals"
  }),
  listReversals: stripeMethod128({
    method: "GET",
    fullPath: "/v1/transfers/{id}/reversals",
    methodType: "list"
  }),
  retrieveReversal: stripeMethod128({
    method: "GET",
    fullPath: "/v1/transfers/{transfer}/reversals/{id}"
  }),
  updateReversal: stripeMethod128({
    method: "POST",
    fullPath: "/v1/transfers/{transfer}/reversals/{id}"
  })
});
...
var WebhookEndpoints = StripeResource.extend({
  create: stripeMethod129({ method: "POST", fullPath: "/v1/webhook_endpoints" }),
...
function createStripe(platformFunctions, requestSender = defaultRequestSenderFactory) {
  Stripe2.PACKAGE_VERSION = "19.1.0";
...
var stripe = stripeSecret ? new stripe_esm_node_default(stripeSecret, { apiVersion: "2024-06-20" }) : null;

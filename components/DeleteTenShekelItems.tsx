...
export const DeleteTenShekelItems: React.FC<Props> = ({ listId, onClose }) => {
  ...
  const analyze = async () => {
    try {
      ...
      addLog('🔍 Searching for ALL 10.00 ₪ items...');
      ...
      history.forEach((item, itemIdx) => {
        ...
        item.prices.forEach((priceEntry, priceIdx) => {
          // Check if price is 10.00
          if (priceEntry.price === 10 || priceEntry.price === 10.00) {
      ...
      addLog(`🎯 Found ${foundCandidates.length} items with 10.00 ₪`);
    ...
    try {
      ...
      deletionsByItem.forEach((priceIndices, itemIndex) => {
        ...
        sortedIndices.forEach(priceIdx => {
          ...
          deletedCount++;
          addLog(`✅ Deleted: ${item.name} (10.00 ₪)`);
        });
      ...
      >
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 p-6 rounded-t-lg">
          ...
          <p className="text-gray-600 mt-2">
            Delete ALL items with 10.00 ₪ price from your purchase history
          </p>
        </div>
        ...
        <div className="p-6">
          {phase === 'idle' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-6">
                This will <strong className="text-red-600">permanently delete</strong> ALL items with 10.00 ₪<br />
                from your entire purchase history
              </p>
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6 text-left max-w-md mx-auto">
                ...
                <div className="text-sm text-yellow-800">
                  This action <strong>cannot be undone</strong>. All 10.00 ₪ price entries will be permanently removed!
                </div>
              </div>
              <button
                onClick={analyze}
            ...
            <div>
              <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
                ...
                <div className="text-sm text-red-800">
                  <div>Found <strong>{candidates.length}</strong> items with 10.00 ₪</div>
                </div>
              </div>
              ...
              {candidates.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    No 10.00 ₪ items found in your purchase history
                  </p>
                  <button
                    onClick={onClose}
          ...
          {phase === 'done' && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-6">
                All 10.00 ₪ items have been deleted.
              </p>
              <button
                onClick={onClose}
                className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors"

...
const translations = {
  ...
  he: {
    ...
    promoCodePlaceholder: "הכנס קוד",
    applyPromoCode: "החל",
    promoCodeApplied: "קוד הופעל",
    promoCodeInvalid: "קוד לא תקין או פג תוקף",
    discount: "הנחה",
  ...
  es: {
    ...
    promoCodePlaceholder: "Ingresa código",
  ...
  ru: {
    ...
    installTitle: "Установить AI Список покупок",
    installMessage: "Добавьте на главный экран для быстрого доступа и автономной работы",
    installButton: "Установить сейчас",
    installLater: "Может быть позже",
    // Paywall
    paywallTitle: "Разблокировать премиум функции",
    paywallSubtitle: "Выберите идеальный план для ваших покупок",
    removeAdsTitle: "Убрать рекламу",
    removeAdsDescription: "Обновитесь до Pro или Family для работы без рекламы",
    upgrade: "Обновить",
    monthly: "Ежемесячно",
    yearly: "Ежегодно",
    savePercent: "Сэкономьте 40%",
    freePlan: "Бесплатно",
    proPlan: "Pro",
    familyPlan: "Семья",
    popularBadge: "САМЫЙ ПОПУЛЯРНЫЙ",
    currentBadge: "Текущий план",
    selectButton: "Начать бесплатную пробную версию",
    continueButton: "Продолжить бесплатно",
    trialInfo: "7-дневная бесплатная пробная версия, отмена в любое время",
    promoCode: "Есть промокод?",
    promoCodePlaceholder: "Введите код",
    applyPromoCode: "Применить",
    promoCodeApplied: "Код применен",
    promoCodeInvalid: "Неверный или истекший код",
    discount: "скидка",
    freeFeature1: "Базовый список покупок",
    freeFeature2: "Базовая AI категоризация (50/месяц)",
    freeFeature3: "1 общий список",
    freeFeature4: "Включает рекламу",
    proFeature1: "Все из Бесплатного",
    proFeature2: "Без рекламы",
    proFeature3: "Неограниченная AI категоризация",
    proFeature4: "Неограниченные общие списки",
    proFeature5: "Полная история покупок",
    proFeature6: "Отслеживание цен и оповещения",
    proFeature7: "Анализ расходов",
    proFeature8: "Умные прогнозы",
    proFeature9: "Приоритетная поддержка",
    familyFeature1: "Все из Pro",
    familyFeature2: "До 5 членов семьи",
    familyFeature3: "Управление администратора",
    familyFeature4: "Общие избранные",
    familyFeature5: "Лента активности семьи",
    familyFeature6: "Управление бюджетом",
  }
};
      ...
      {showPaywall && (
        <PaywallModal
          ...
          translations={{
            ...
            promoCode: currentText.promoCode,
            promoCodePlaceholder: currentText.promoCodePlaceholder,
            applyPromoCode: currentText.applyPromoCode,
            promoCodeApplied: currentText.promoCodeApplied,
            promoCodeInvalid: currentText.promoCodeInvalid,
            discount: currentText.discount,
            features: {
              free: [
